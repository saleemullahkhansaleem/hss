...
export default function ServiceDetail() {
  ...
  const servicesData = [
    ...
    },
    {
      ...
      description:
        "Syed Hanif Shah strives to grow together with clients, focusing on success through brand and company transformation. We leverage strategy, consulting, development, management, and research to create impactful digital and real-world experiences. By combining our unique process and community, we build strong partnerships that drive growth.",
    ...
    },
    {
      ...
      description:
        "As a pioneer in the real estate sector, Syed Hanif Shah has vast experience meeting the diverse needs of our clients. Based in Blue Area, Islamabad, we handle all real estate transactions and advisory services for profitable investments. Our network of investors enables us to offer the best and most cost-effective options.",
    ...
    },
    {
      ...
      subTopics: [
        ...
        },
        {
          ...
          title: "Fuel Minerals",
          description:
            "Syed Hanif Shah offers services in the exploration and development of fuel minerals, ensuring a stable and sustainable supply for energy needs.",
        },
        {
          id: "gemstones",
          title: "Gemstones",
